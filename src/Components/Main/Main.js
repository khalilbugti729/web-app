    ...
    <div className="main__div">
      ...
      <div className="service">
        ...
        <div className="service__define">
          <br></br>Services Serving more than 6,000 global brands worldwide,
          Lyngva provides a range of customised,
          <br></br>affordable translation and localisation services to suit your
          multilingual needs, across multiple
          <br></br>industries, content types and platforms. We made it our
          mission to deliver your stories globally
      ...
      <div className="Channel__link">
        Our list of services does not end here. We’ll adapt to your particular
        needs. <a href="Google.com">Get a Quote for Your Business</a>
      </div>
      <div className="youtube__link">
        ...
        <div className="youtube__learn">
          ...
          <div className="youtube__define">
            <br></br>Armed with a global network of production facilities, we
            can
            <br></br>translate anything into over 60 languages, guaranteeing
            client
            <br></br>satisfaction. We’re happy to provide free price quotes for
            any
            <br></br>document, user manual, website or software localization
            project. In
            <br></br>order for us to live up to our promise of an outstanding
            service,
            <br></br>each job is assigned to linguists with specializations in
            various
      ...
      <div className="language">
        ...
        <div className="language__define">
          <br></br>Our advanced network of translators and linguists deliver
          content for more than 6,000 global brands
          <br></br>in 100 target languages and 400 language pairs. We are fast,
      ...
      <div className="flag">
        ...
        <div className="flag__title">
          ...
          <div className="flag__define">
            ...
            <br></br>translated, your order will be served by a<br></br>proper
      ...
      <div className="Icon__Link">
        <img
          src="/images/icon.jpg"
          alt=""
          style={{ width: "100%", padding: "1rem", paddingTop: "10%" }}
        />
      </div>
      <div className="price__firt-part">
        <h1>Our Pricing</h1>
        <h4>
          Our advanced network of translators and linguists deliver content for
          more than 6,000 global brands in 100 target languages and 400 language
